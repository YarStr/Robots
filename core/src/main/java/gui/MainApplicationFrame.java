...
public class MainApplicationFrame extends JFrame implements PropertyChangeListener {
    ...
    private void initializeRobotPlugin() {
        PluginLoader pluginLoader = new PluginLoader(this, bundle);
        robotPlugin = pluginLoader.getRobotPlugin();
    }
    ...
    private void initializeWindows() {
        gameController = new GameController(400, 400, robotPlugin.getRobot());
        ...
        gameWindow = new GameWindow(gameController, dispatcher, confirmCloseInternalFrameAdapter, robotPlugin.getDrawer());
